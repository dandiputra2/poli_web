...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // jika tidak tambahkan data baru
        ...
        // jika sudah ada datanya maka akan generate no urut berdasarkan no_rm data terakhir
            ...
            if ($queryInsertBaru) {
                echo '<script>alert("Pendaftaran akun berhasil");window.location.href="../../tampilPasien.php";</script>';
            } else {
                echo '<script>alert("Pendaftaran akun gagal");window.location.href="../../tampilPasien.php";</script>';
            }
        }
    }
}
