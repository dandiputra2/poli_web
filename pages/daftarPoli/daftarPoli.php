        ...
        <div class="col-md-4">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="pages/daftarPoli/tambahDaftarPoli.php" method="post">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <!-- Menampilkan Data Riwayat Pendaftaran Poli -->
                            <?php
                            // Mengambil data riwayat pendaftaran poli dari database
                            require 'config/koneksi.php';
                            $no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="tampilDetailDaftarPoli.php?id=<?php echo $data['idDaftarPoli'] ?>" class='btn btn-sm btn-success edit-btn'>Detail</a>
                                    </td>
                                </tr>
                            <?php } ?>
