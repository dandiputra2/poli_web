<section>
    ...
    <div class="invoice p-3 mb-3">
        ...
        <div class="row no-print">
            <div class="col-12">
                <div class="d-flex justify-content-center"><button type="button" class="btn btn-danger" style="margin-right: 5px;">
                        <a href="tampilPeriksa.php" class="text-white">Close</a>
                </div>
            </div>
        </div>
    </div>
