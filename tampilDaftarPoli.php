...
<body class="hold-transition sidebar-mini">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>&copy; 2024/2025  <a href="https://wa.link/2lflpo" class="text-yellow-400 hover:underline">A11.2021.13684_Dandi Mahendra Putra Firdaus</a>.</strong> All rights reserved.
    </footer>
    </center>
  </div>
    </div>
